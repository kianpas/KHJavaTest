...
public class MovieA {
    ...
    public MovieA(String movieTitle) {
		this.movieTitle = movieTitle;
    }
    
    public MovieA(String movieTitle, String director) {
    	this(movieTitle);
		this.director = director;
    }
    
    public MovieA(String movieTitle, String director, String[] casting) {
    	this(movieTitle, director);
		this.casting = casting;
    }
    
    public MovieA(String movieTitle, String director, String[] casting, Calendar release) {
